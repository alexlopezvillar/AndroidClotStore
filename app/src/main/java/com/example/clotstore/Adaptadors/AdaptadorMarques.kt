...
import com.example.clotstore.API.Marca
import com.example.clotstore.ProductesMenu.ActivityMarques
import com.example.clotstore.R

class AdaptadorMarques(var llista: ArrayList<Marca>) :
    RecyclerView.Adapter<AdaptadorMarques.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.vista.setOnClickListener {
            val intent = Intent(holder.vista.context, ActivityMarques::class.java)
            intent.putExtra("idMarca", llista[position].idMarca)
