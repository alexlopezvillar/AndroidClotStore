...
class AdaptadorOutfits(var llista: ArrayList<Producte>?) :
    RecyclerView.Adapter<AdaptadorOutfits.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        vh = ViewHolder(layout.inflate(R.layout.cardview_productes2, parent, false))
        return vh!!
    }
