...
class AdaptadorProductesMenu(var llista: ArrayList<Producte>) :
    RecyclerView.Adapter<AdaptadorProductesMenu.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        vh = ViewHolder(layout.inflate(R.layout.cardview_productes_3, parent, false))
        return vh!!
    }
